...
/** Access tier for a product. The Islamic Legacy books are Premium; the worship
 * trackers (wudu, checklists, logs) are free (basic); explicit `tier` wins. */
export function productTier(p: DigitalProduct): "basic" | "premium" | "family" {
  return p.tier ?? (p.category === "Islamic Legacy" ? "premium" : "basic");
}
...
export const products: DigitalProduct[] = [
  ...
  // ── Learning Path (Islamic Legacy) ───────────────────────────────────────────
  {
    id: 15,
    slug: "tajweed-made-easy",
    title: "Tajweed Made Easy",
    arabicTitle: "أحكام التجويد",
    subtitle: "Recite the Quran as it was revealed",
    category: "Islamic Legacy",
    type: "Book",
    price: "Free",
    pages: 12,
    ...
    featured: true,
    description:
      "A clear, step-by-step guide to the rules of tajweed — the articulation points, the noon & meem rules, madd, and qalqalah — so every ayah is recited beautifully and correctly.",
    features: [
      "Makharij — the articulation points",
      "Noon & meem sakinah rules (ikhfa, idgham, ghunnah)",
      "The types of madd (elongation)",
      "Qalqalah & practical drills",
    ],
    printable: {
      kind: "book",
      note: "A learning companion — table of contents below.",
      chapters: [
        "Why Tajweed Matters", "The Articulation Points (Makharij)",
        "Noon Sakinah & Tanween", "Meem Sakinah", "The Rules of Madd",
        "Qalqalah & Laam/Raa", "Common Mistakes & How to Fix Them",
      ],
    },
  },
  {
    id: 16,
    slug: "the-99-names-of-allah",
    title: "The 99 Names of Allah",
    arabicTitle: "أسماء الله الحسنى",
    subtitle: "Know your Lord by His beautiful names",
    category: "Islamic Legacy",
    type: "Book",
    price: "$4",
    oldPrice: "$7",
    ...
    pattern: "stars",
    description:
      "Each of the 99 beautiful names of Allah — with its meaning, a short reflection, and how to live by it. A lifelong companion for du'a and dhikr.",
    features: [
      "All 99 names with meanings",
      "A reflection for each name",
      "Transliteration + Arabic",
      "How to call on Allah by them",
    ],
    printable: {
      kind: "book",
      note: "A reading companion — table of contents below.",
      chapters: [
        "The Meaning of Al-Asma al-Husna", "Ar-Rahman & Ar-Raheem",
        "Al-Malik, Al-Quddus, As-Salam", "Al-Ghaffar & At-Tawwab",
        "Al-Razzaq & Al-Wahhab", "Al-Hakeem & Al-'Aleem",
        "Living by the Names in Du'a",
      ],
    },
  },
  {
    ...
    subtitle: "From birth in Makkah to the final sermon",
    category: "Islamic Legacy",
    type: "Book",
    price: "$4",
    oldPrice: "$8",
    ...
    featured: true,
    description:
      "The complete life story of Prophet Muhammad ﷺ — Makkah and the first revelation, the Hijrah, the battles, and the mercy that changed the world — told with warmth and clarity.",
    features: [
      "Birth, childhood & the first revelation",
      "The Makkan trials & the Hijrah",
      "Madinah, the treaties & the battles",
      "The conquest of Makkah & the farewell",
    ],
    printable: {
      kind: "book",
      note: "A reading companion — table of contents below.",
      chapters: [
        "Arabia Before Islam", "Birth & Early Life", "The First Revelation",
        "The Makkan Years & Persecution", "The Hijrah to Madinah",
        "Building the Community", "Badr, Uhud & the Trench",
        "The Conquest of Makkah", "The Farewell Sermon",
      ],
    },
  },
  {
    ...
    subtitle: "The pillars of the deen in 42 hadith",
    category: "Islamic Legacy",
    type: "Book",
    price: "Free",
    pages: 18,
    format: "PDF",
    gradient: "from-stone-800 via-amber-950 to-stone-950",
    accent: "#d6a84f",
    pattern: "geometric",
    description:
      "Imam an-Nawawi's timeless collection — the hadith that gather the essentials of Islam. Arabic text, translation, and a short explanation of each.",
    features: [
      "All 42 hadith, Arabic + English",
      "A concise commentary on each",
      "\"Actions are by intentions\" & more",
      "Memorization-friendly layout",
    ],
    printable: {
      kind: "book",
      note: "A study companion — selected hadith below.",
      chapters: [
        "1 — Actions are by Intentions", "2 — Islam, Iman & Ihsan",
        "3 — The Pillars of Islam", "6 — The Halal & Haram are Clear",
        "13 — Love for your Brother", "34 — Changing Wrong with your Hand",
        "40 — Be in this World as a Traveller",
      ],
    },
  },
  {
    ...
    arabicTitle: "تفسير جزء عمّ",
    subtitle: "Understand the surahs you pray with",
    category: "Islamic Legacy",
    type: "Book",
    price: "$3",
    oldPrice: "$6",
    ...
    pattern: "calligraphy",
    description:
      "A clear tafsir of the 37 short surahs of Juz 'Amma — the ones we recite most in salah. Meaning, context, and lessons so your prayer comes alive.",
    features: [
      "All of Juz 'Amma explained",
      "Reason for revelation where known",
      "Word meanings & key lessons",
      "Perfect alongside memorization",
    ],
    printable: {
      kind: "book",
      note: "A study companion — selected surahs below.",
      chapters: [
        "An-Naba' — The Great News", "An-Nazi'at & 'Abasa",
        "Al-Infitar & Al-Mutaffifin", "Al-A'la & Al-Ghashiyah",
        "Ad-Duha & Ash-Sharh", "Al-Ikhlas, Al-Falaq & An-Nas",
      ],
    },
  },
  {
    ...
    title: "Fortress of the Muslim — Daily Du'as",
    arabicTitle: "حصن المسلم",
    subtitle: "Authentic supplications for every moment",
    category: "Islamic Legacy",
    type: "Book",
    price: "Free",
    pages: 16,
    ...
    featured: true,
    description:
      "The essential authentic du'as for daily life — waking, sleeping, eating, travel, distress, and protection — with Arabic, transliteration, and meaning.",
    features: [
      "Morning & evening adhkar",
      "Du'as for sleep, food & travel",
      "Du'as for anxiety & protection",
      "Arabic + transliteration + meaning",
    ],
    printable: {
      kind: "book",
      note: "A reference companion — sections below.",
      chapters: [
        "Waking & Sleeping", "Wudu & the Masjid", "Before & After Eating",
        "Leaving & Entering the Home", "Travel & the Journey",
        "Distress, Anxiety & Protection", "Morning & Evening Adhkar",
      ],
    },
  },
  {
    ...
    subtitle: "The beauty of the Prophetic character",
    category: "Islamic Legacy",
    type: "Book",
    price: "$3",
    pages: 14,
    ...
    pattern: "geometric",
    description:
      "Akhlaq — the manners that complete our faith. Honesty, mercy, patience, gratitude, and the etiquette of speech, gatherings, and family, drawn from the Sunnah.",
    features: [
      "The manners the Prophet ﷺ taught",
      "Speech, gatherings & family adab",
      "Honesty, mercy, patience & gratitude",
      "Great for families & young learners",
    ],
    printable: {
      kind: "book",
      note: "A reading companion — table of contents below.",
      chapters: [
        "Why Character is Half the Deen", "Honesty & Keeping Trust",
        "Mercy, Kindness & Forgiveness", "Patience & Gratitude",
        "The Etiquette of Speech", "Adab with Parents & Family",
        "Manners of Gatherings & the Guest",
      ],
    },
  },
];
