...
export const products: DigitalProduct[] = [
  // ── Islamic Legacy ──────────────────────────────────────────────────────────
  {
    ...
    featured: true,
    description:
      "Concise, inspiring biographies of the Companions of the Prophet ﷺ — their faith, sacrifice, and the legacy they left for every generation after them.",
    features: [
      "20 illustrated companion biographies",
      "Timeline of early Islam",
      "Lessons & reflections after each chapter",
  ...
  },
  {
    ...
    features: [
      "A chapter on each of the four Caliphs",
      "Maps of the early expansion",
      "Key decisions & their wisdom",
  ...
  },
  {
    ...
    pattern: "stars",
    description:
      "The timeless stories of the Prophets, retold with clarity and rooted in the Quran and authentic narrations — for readers of every age.",
    features: [
      "25 prophet narratives",
      "Quranic references throughout",
